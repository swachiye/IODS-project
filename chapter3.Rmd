...
**Exploring the relationship of the variables with alcohol consumption**
```{r}
...
Assess each variable with alcohol consumption
...
```{r} 
# Exploring relationship of parent status and alcohol consumption
...
```{r}
# Exploring relationship of failure and alcohol consumption
