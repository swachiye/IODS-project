...
```
With the first discriminant, we get a clean separation between the classess. However, in second and third discriminant we have overlap between the classess.
...
mean(lda.pred$class==test_data$crime) 
```
